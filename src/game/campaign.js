...
export const STARTER_DECK = mk([
  ['f01', 3], ['g01', 3], ['w01', 2],              // 1コスト 8枚
  ['f03', 3], ['w03', 2], ['g03', 3],              // 2コスト 8枚
  ['f05', 2], ['w05', 2], ['g05', 1],              // 3コスト 5枚
  ['g07', 2],                                       // 4コスト 2枚
  ['f09', 1],                                       // 5コスト 1枚
  ['sf1', 2], ['sn2', 2], ['sn1', 1], ['sn5', 1],  // サポート 6枚
]);
...
export const AREAS = [
  ...
  },
  {
    ...
    enemies: [
      ...
      ]), { noise: 4, life: 20, profile: 'aggro', desc: 'とにかく速い。序盤で殴り切られる。' }),
      E('溶岩守りゴウ', '🌋', mk([
        ['f06', 3], ['f05', 3], ['f03', 3], ['f08', 3], ['f01', 2], ['g03', 3], ['g05', 2],
        ['sf2', 3], ['sn5', 3], ['sf3', 3], ['sn6', 2],
      ]), { noise: 3, life: 20, desc: '【貫通】で守護を無視してくる。' }),
      E('炎皇バルガ', '👹', mk([
        ['f03', 3], ['f05', 3], ['f07', 3], ['f08', 3], ['f09', 3], ['f10', 2],
        ['sf1', 3], ['sf2', 3], ['sf3', 3], ['sf4', 2], ['sn6', 2],
      ]), { noise: 2, life: 22, profile: 'aggro', desc: 'エリアボス。煉獄竜を従える。' }),
    ],
  },
  {
    ...
    enemies: [
      ...
      ]), { noise: 1, life: 22, startCost: 1, desc: '回復とドローで粘りながら削ってくる。' }),
      E('氷壁のヴァル', '🧊', mk([
        ['w05', 3], ['w08', 3], ['x_w3', 3], ['x_w7', 3], ['w01', 2], ['x_w4', 3],
        ['sw2', 3], ['x_sw3', 3], ['x_sw4', 2], ['sn5', 3], ['sn8', 2],
      ]), { noise: 0, life: 22, startCost: 1, profile: 'turtle', desc: '守護の壁を並べ、山札まで削ってくる。' }),
      E('海皇ネプト', '🔱', mk([
        ['w01', 2], ['w03', 3], ['w07', 3], ['x_w1', 2], ['x_w4', 3], ['x_w5', 3], ['w09', 2], ['x_w6', 2], ['w10', 2],
        ['sw4', 3], ['x_sw5', 3], ['sw3', 2],
      ]), { noise: 0, life: 22, startCost: 1, desc: 'エリアボス。大海嘯の王を呼ぶ。' }),
    ],
  },
  {
    ...
    enemies: [
      ...
      ]), { noise: 0, life: 24, startCost: 1, desc: '強化を重ねて巨大化させてくる。' }),
      E('森の狩人ヨナ', '🏹', mk([
        ['f01', 3], ['f03', 3], ['f05', 3], ['f08', 2], ['f09', 2],
        ['g01', 3], ['g03', 3], ['x_g2', 2], ['g07', 2],
        ['sf2', 2], ['sg1', 3], ['sn6', 2],
      ]), { noise: 0, life: 22, profile: 'aggro', desc: '炎と草の合わせ技。隙がない。' }),
      E('世界樹の守護者', '🌳', mk([
        ['g01', 2], ['x_g2', 3], ['x_g3', 3], ['g07', 3], ['x_g4', 2], ['x_g5', 3], ['g09', 3], ['g10', 2],
        ['x_sg4', 3], ['x_sg1', 3], ['sg1', 3],
      ]), { noise: 0, life: 26, startCost: 1, desc: 'エリアボス。ユグドラの加護を受ける。' }),
    ],
  },
  {
    ...
    enemies: [
      E('双子の術士', '👯', mk([
        ...
        ['sf3', 3], ['x_sf1', 3], ['sn6', 2],
      ]), { noise: 0, life: 24, startCost: 1, desc: '三属性を器用に使い分ける。' }),
      E('無銘の剣士', '⚔️', mk([
        ['f01', 3], ['f03', 3], ['f05', 3], ['x_f2', 3], ['x_f4', 3], ['f08', 2], ['f09', 2],
        ['sf2', 3], ['x_sf1', 3], ['x_sf3', 3], ['sf1', 2],
      ]), { noise: 0, life: 24, startCost: 1, profile: 'aggro', desc: '純粋な殴り合いを挑んでくる。連撃に注意。' }),
      E('三属の王 トリアデス', '👑', mk([
        ['f01', 3], ['f03', 2], ['f05', 3], ['x_f2', 2], ['x_f5', 2], ['f09', 2], ['f10', 2],
        ['x_w4', 2], ['x_w5', 2], ['x_g5', 2], ['x_g6', 2],
        ['x_sf3', 3], ['sf2', 3],
      ]), { noise: 0, life: 26, startCost: 1, desc: '最終ボス。三属性の切り札を全て操る。' }),
    ],
  },
];
...
export const PACK_TYPES = {
  bronze: { name: 'ブロンズパック', size: 5, weights: { 1: 70, 2: 28, 3: 2 },  set2Rate: 0.35 },
  silver: { name: 'シルバーパック', size: 5, weights: { 1: 35, 2: 52, 3: 13 }, set2Rate: 0.55 },
  gold:   { name: 'ゴールドパック', size: 5, weights: { 1: 10, 2: 55, 3: 35 }, set2Rate: 0.75 },
};
...
export function openPack(type, rand = Math.random) {
  ...
  for (let i = 0; i < t.size; i++) {
    // 最後の1枚は必ず tier2 以上（当たり枠）
    const w = i === t.size - 1 ? { 1: 0, 2: 70, 3: 30 } : t.weights;
    const total = Object.values(w).reduce((a, b) => a + b, 0);
    let r = rand() * total, tier = 1;
    for (const [k, v] of Object.entries(w)) { r -= v; if (r <= 0) { tier = Number(k); break; } }
    const wantSet2 = rand() < (t.set2Rate ?? 0.5);
    let pool = ALL_CARDS.filter(c => c.tier === tier && (wantSet2 ? c.set === 2 : c.set === 1));
    if (!pool.length) pool = ALL_CARDS.filter(c => c.tier === tier);
